      ...
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="flex items-center group">
          <div className="relative overflow-hidden rounded-lg mr-3 gradient-border logo-container">
            <img src="/logo.jpeg" alt="Base PingPong Logo" className="h-12 w-12 object-cover" />
          </div>
          <span className="text-xl font-bold">
            <span className="text-gradient text-shadow group-hover:animate-pulse transition-all duration-300">BASE</span>{' '}
          ...
          {walletState === 'connected' ? (
            <div className="flex items-center space-x-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="enhanced-glass border border-monad-300/30">
        ...
        <div className="md:hidden flex items-center">
          {walletState === 'connected' && (
            <Button
              variant="outline"
              size="icon"
              className="mr-2 glass-button text-neon-blue"
              onClick={toggleMenu}
            >
