...
const NFTMintForm = ({ onSuccess }: NFTMintFormProps) => {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      console.log(`Minting NFT with estimated value: ${price} ETH (free for hackathon demo)`);
      ...
      <div className="pt-4 mt-4 border-t border-gray-800">
        <div className="flex justify-between items-center mb-2">
          ...
          <span className="text-lg font-bold text-neon-green">
            {getNFTPrice(nftType, nftType === NFTType.Paddle ? paddleRarity : nftType === NFTType.Avatar ? avatarRarity : trailRarity)} ETH
          </span>
        </div>
