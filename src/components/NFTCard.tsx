...
const NFTCard = ({ tokenId, owner, attributes, price, isOwner, onAction }: NFTCardProps) => {
  ...
  const handleList = async () => {
    try {
      ...
      console.log(`Listing NFT with ID ${tokenId.toString()} for ${priceToUse} ETH`);
      ...
      toast.success(`NFT ${isListed ? 'price updated' : 'listed'} for ${priceToUse} ETH successfully!`);
      ...
      <CardFooter className="flex flex-col space-y-2">
          ...
          <div className="w-full space-y-4 p-4 bg-black/30 rounded-md border border-monad-300/20">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <span className="text-neon-green font-bold">ETH</span>
              </div>
            </div>
        ...
        {isOwner && isListed && (
          <div className="w-full space-y-4 p-4 bg-black/30 rounded-md border border-monad-300/20">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Current price: <span className="text-neon-pink font-medium">{formattedPrice} ETH</span></p>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <span className="text-neon-pink font-bold">ETH</span>
              </div>
            </div>
        ...
        {!isOwner && isListed && (
          ...
          >
            ...
            <span className="text-gradient-green text-lg font-bold">{isBuying ? 'Buying...' : `Buy for ${formattedPrice} ETH`}</span>
          </Button>
        )}
      </CardFooter>
    </Card>
