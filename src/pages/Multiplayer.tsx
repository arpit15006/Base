...
const Multiplayer = () => {
  ...
  const { address, walletState, isCorrectChain, switchToBaseChain, connect } = useWallet();
  ...
  const handleCreateMatch = async () => {
    ...
    if (!isValidAddress(opponentAddress)) {
      toast.error('Invalid opponent base address');
      return;
    }
      ...
      {walletState !== 'connected' ? (
        ...
        <div className="max-w-md mx-auto glass-card p-6 text-center space-y-4">
          <p className="text-gray-300 neon-text">
            Please switch to the Base chain to access multiplayer features
          </p>
          <Button
            className="bg-monad hover:bg-monad-600"
              ...
              <div className="glass-card p-6 space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Enter the Base address of the player you want to challenge
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="0.0001">0.0001 ETH</SelectItem>
                      <SelectItem value="0.0005">0.0005 ETH</SelectItem>
                      <SelectItem value="0.001">0.001 ETH</SelectItem>
                      <SelectItem value="0.005">0.005 ETH</SelectItem>
                      <SelectItem value="0.01">0.01 ETH</SelectItem>
                      <SelectItem value="0.05">0.05 ETH</SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-xs text-gray-500">
                    Small amount of ETH to stake on this match. Using minimal amounts for Base mainnet. Winner takes all.
                  </p>
                </div>
