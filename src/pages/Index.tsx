      ...
      <section className="flex flex-col items-center text-center space-y-6 pt-10 pb-16 relative">
        ...
        <div className="relative">
          <h1 className="text-5xl md:text-7xl font-bold max-w-3xl leading-tight">
            <span className="text-gradient text-shadow">BASE </span>
        ...
        <p className="text-xl text-gray-300 max-w-2xl">
          The classic arcade game reimagined on the Base blockchain.
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="enhanced-glass gradient-border p-8 py-10 relative overflow-hidden group card-hover neon-glow-blue">
          ...
          <p className="text-gray-300 text-sm px-1">
            Play PingPong on the Base blockchain. Create matches, stake ETH, and compete for rewards.
          </p>
        ...
        <div className="enhanced-glass gradient-border p-8 py-10 relative overflow-hidden group card-hover neon-glow-green">
          ...
          <p className="text-gray-300 text-sm px-1">
            Stake ETH on matches and earn rewards for winning. Track your stats and earnings.
          </p>
        ...
        <div className="space-y-8 px-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Connect your wallet to the Base chain to access all game features.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Create a new match by staking ETH or join an existing open challenge.
              </p>
            </div>
          </div>
