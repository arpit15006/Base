...
const Admin = () => {
  const { address, walletState, connect, isCorrectChain, switchToBaseChain } = useWallet();
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <Card className="max-w-md mx-auto">
          <CardHeader>
            <CardTitle>Admin Panel</CardTitle>
            <CardDescription>Switch to Base Chain to access admin features</CardDescription>
          </CardHeader>
          <CardFooter>
            <Button onClick={switchToBaseChain} className="w-full">Switch to Base Chain</Button>
          </CardFooter>
        </Card>
      </div>
    );
                      ...
                      <CardContent className="pt-6">
                        <div className="grid grid-cols-2 gap-4 mb-4">
                          ...
                          <div>
                            ...
                            <p className="font-medium text-neon-green">{game.stake} ETH</p>
                          </div>
                        </div>
                          ...
                          {game.isFinished ? (
                            <div>
                              ...
                              <p className="text-xs text-gray-400 mt-1">
                                Winner received {parseFloat(game.stake)} ETH (total staked amount)
                              </p>
                            </div>
                          ) : game.gameCompleted ? (
                            <div className="flex justify-between items-center">
                              <div>
                                ...
                                <p className="text-xs text-gray-400 mt-1">
                                  Please declare the winner to distribute {parseFloat(game.stake)} ETH
                                </p>
                              </div>
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-800">
                          ...
                          {game.isFinished ? (
                            <>
                              ...
                              <p className="font-medium text-neon-green">{shortenAddress(game.winner)}</p>
                              <p className="text-xs text-gray-400 mt-1">
                                Winner received {parseFloat(game.stake)} ETH
                              </p>
                            </>
                          ) : game.declaredWinner ? (
                            <>
                              ...
                              <p className="text-xs text-gray-400 mt-1">
                                Waiting for admin confirmation to transfer {parseFloat(game.stake)} ETH
                              </p>
                            </>
                          ) : game.gameCompleted ? (
                            <div className="flex justify-between items-center">
