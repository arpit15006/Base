...
const Play = () => {
  ...
  const { address, walletState, isCorrectChain, switchToBaseChain } = useWallet();
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      ...
      {loading ? (
        ...
        <div className="max-w-md mx-auto bg-gray-900/50 rounded-lg border border-gray-800 p-6 text-center space-y-4">
          <p className="text-gray-300">
            Please switch to the Base chain to view match details
          </p>
          <Button
          ...
          <div className="bg-gray-900/50 rounded-lg border border-gray-800 p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="font-medium text-neon-green">{stake} ETH</div>
              </div>
