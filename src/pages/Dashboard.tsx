...
const Dashboard = () => {
  const { walletState, connect, isCorrectChain, switchToBaseChain } = useWallet();
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      {walletState !== 'connected' ? (
        ...
        <div className="glass p-8 text-center">
          <p className="text-gray-300 mb-4">Please switch to the Base Chain to view game analytics</p>
          <button
