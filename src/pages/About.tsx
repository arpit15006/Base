  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-12 mb-12">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold glow-text text-monad-300">About Base PingPong Arena</h1>
        <p className="text-gray-400 mt-2">
          A blockchain-based ping pong game on the Base Mainnet
        </p>
      </div>
      ...
      <section className="max-w-3xl mx-auto glass p-8">
        ...
        <p className="text-gray-300">
          Base PingPong Arena is a blockchain-integrated ping pong game built on the Base mainnet.
          It combines the classic arcade game with Web3 functionality, allowing players to create matches,
          stake ETH tokens, and compete for rewards. The game is fully decentralized, with all match results
        ...
        <div className="space-y-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Full integration with the Base Mainnet blockchain. Create matches, stake tokens,
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div>
              ...
              <p className="text-gray-300">
                The game is powered by a smart contract on the Base Mainnet, ensuring
      ...
      <section className="max-w-3xl mx-auto glass p-8">
        ...
        <p className="text-gray-300 mb-4">
          Base PingPong Arena is built with modern web technologies and blockchain integration:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-300 pl-4">
          ...
          <li>Smart contract deployed on the Base Mainnet</li>
        </ul>
      </section>
      ...
      <section className="max-w-3xl mx-auto glass p-8">
        ...
        <p className="text-gray-300 mb-4">
          The game is powered by a smart contract deployed on the Base Mainnet.
        ...
        <div className="bg-gray-900/50 p-4 rounded-md font-mono text-sm my-4 break-all border border-monad-500/30">
          Contract Address: 0x661D8753e6909EbbBeB0bd2551A0418b530eF1DF
        </div>
        ...
        <div className="mt-6">
          <a
            href="https://basescan.org/address/0x661D8753e6909EbbBeB0bd2551A0418b530eF1DF"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 text-neon-blue hover:underline"
          >
            View contract on Basescan <ArrowRight className="h-4 w-4" />
          </a>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <p className="text-gray-300">
              ...
              and Base Ping Pong is the result of that vision.
            </p>
            <p className="text-gray-300">
        ...
        <div className="glass-card p-8 text-center relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-gray-300 mb-6">
              Try your skills in the Base PingPong Arena and compete for rewards on the blockchain.
            </p>
      ...
      <footer className="max-w-3xl mx-auto text-center text-gray-500 text-sm py-6 border-t border-monad-500/20">
        <p>
          Base PingPong Arena © 2025 | Built for the Base Blockchain | Built by Arpit Patel |
        </p>
        <div className="flex justify-center mt-2">
          <a
            href="https://github.com/arpit15006/Base-PingPong-Arena.git"
            target="_blank"
            rel="noreferrer"
